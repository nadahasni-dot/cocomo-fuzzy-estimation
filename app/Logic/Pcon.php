...
class Pcon extends Membership
{
    ...
    public function calculateMembership()
    {
        ...
        if ($input > 0.81 && $input < 0.9) {
            $veryHigh = $this->alphaPredicateDown(0.81, 0.9, $input);
        }
        ...
        if ($input > 0.81 && $input < 0.9) {
            $high = $this->alphaPredicateUp(0.81, 0.9, $input);
        }
        ...
        if ($input > 1 && $input < 1.12) {
            $nominal = $this->alphaPredicateDown(1, 1.12, $input);
        }
        ...
        if ($input > 1 && $input < 1.12) {
            $low = $this->alphaPredicateUp(1, 1.12, $input);
        }
        ...
        if ($input > 1.12 && $input < 1.29) {
            $low = $this->alphaPredicateDown(1.12, 1.29, $input);
        }
        ...
        if ($input > 1.12 && $input < 1.29) {
            $veryLow = $this->alphaPredicateUp(1.12, 1.29, $input);
        }
