...
class Plex extends Membership
{
    ...
    public function calculateMembership()
    {
        ...
        if ($input > 0.85 && $input < 0.91) {
            $veryHigh = $this->alphaPredicateDown(0.85, 0.91, $input);
        }
        ...
        if ($input > 0.85 && $input < 0.91) {
            $high = $this->alphaPredicateUp(0.85, 0.91, $input);
        }
        ...
        if ($input > 1.09 && $input < 1.19) {
            $low = $this->alphaPredicateDown(1.09, 1.19, $input);
        }
        ...
        if ($input > 1.09 && $input < 1.19) {
            $veryLow = $this->alphaPredicateUp(1.09, 1.19, $input);
        }
